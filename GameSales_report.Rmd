...
The goal of this project is to build a prediction system for video game sales based on sales data from VGChartz and ratings form Metacritic. The dataset has been created by Rush Kirubi (see https://www.kaggle.com/rush4ratio/video-game-sales-with-ratings).
